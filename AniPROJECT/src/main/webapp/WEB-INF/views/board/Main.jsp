...
function pop() { 
	window.open("/board/pop", "pop", 
	"width=1050,height=800,history=no,resizable=no,status=no,scrollbars=yes,menubar=no")
}
	
</script>

<body id="myPage" data-spy="scroll" data-target=".navbar"
	data-offset="50" onload="javascript:pop()">
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="/static/images/Main1.jpg" alt="메인 사진1" width="1100"
					height="550">
			...
			<div class="item">
				<img src="/static/images/메인사진2.jpg" alt="메인사진2" width="1100"
					height="550">
				<div class="carousel-caption">
					<h3>나만의 삼점</h3>
			...
			<div class="item">
				<img src="/static/images/메인사진3.jpg" alt="메인 사진3" width="1100"
					height="550">
				<div class="carousel-caption">
	...
	<div id="band" class="container">
		...
		<p>저희는 그저 중고피규어 판매 사이트가 아닙니다.! 넘치고 넘치는 판매 사이트를 제외하고 어떻게 해야 저희 사이트를
			선택할지?</p>
		<p>그저 판매가 아닌 즐거움 또한 느낄 수 있는 법이 없는지를 많은 고민을 했지만 저는 그거 즐기면 좋고 돈도 생기면
			좋고 심심할 때 들어오면 좋은 사이트를 만드는 게 목표인 것을 떠 올렸습니다.</p>
		<p>본 사이트는 방구석 1급 피규어제작자들이 자신의 피규어 자작 피규어를 만들어 다른 사람들이 그걸 보고 인정해 주고
			즐거워해주길 봐라는 마음으로 제작되었습니다.</p>
		<p>중고피규어를 판매하고 제작피규어를 판매하고 그리고 무엇보다도 자작피규어 설정을 만화, 소설, 일러스트 등등 다양한
			방법으로 표현해 보세요.!</p>
		<br>
		...
		<div class="row">
			<div class="col-sm-4">
				...
				<br> <a href="#demo" data-toggle="collapse"> <img
					src="/static/images/서브사진2.jpg" class="img-circle person"
			...
			<div class="col-sm-4">
				...
				<br> <a href="#demo2" data-toggle="collapse"> <img
					src="/static/images/서브사진3.jpg" class="img-circle person"
					alt="Random Name" width="80" height="80">
				</a>
			...
			<div class="col-sm-4">
				...
				<br> <a href="#demo3" data-toggle="collapse"> <img
					src="/static/images/서브사진4.jpg" class="img-circle person"
					alt="Random Name" width="80" height="80">
				</a>
	...
	<div id="soo">
		<div class="container">
			...
			<p>Everyone in the world can buy what they want, but few can make
				what they want....</p>
		</div>
		...
		<div class="row text-center">
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="/static/images/프로필1.jpg" alt="Paris" width="400"
						height="300">
					<p>
						<strong>프로필</strong>
					</p>
			...
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="/static/images/프로필2.jpg" alt="New York" width="400"
						height="300">
					<p>
						<strong>프로필</strong>
					</p>
			...
			<div class="col-sm-4">
				<div class="thumbnail">
					<img src="/static/images/프로필3.jpg" alt="San Francisco" width="400"
						height="300">
					<p>
						<strong>프로필</strong>
					</p>
