		...
		<div class="col-sm-3">
			<div class="thumbnail">
				<img src="/static/images/jackets.jpg" width="600" height="400"
					onclick="location.href='/product/detail2/13'">
				<p>
					<strong>프로필</strong>
				</p>
				<p>Jacket</p>
				...
				<button class="btn btn-default"
					onclick="location.href='/product/detail2/13'">More
					Click</button>
			</div>
		</div>
		...
		<div class="col-sm-3" style=>
			<div class="thumbnail">
				<img src="/static/images/blazers.jpg" width="600" height="400"
					onclick="location.href='/product/detail2/14'">
				<p>
					<strong>프로필</strong>
				</p>
				<p>Blazer</p>
		...
		<div class="col-sm-3">
			<div class="thumbnail">
				<img src="/static/images/jeans.jpg" width="600" height="400"
					onclick="location.href='/product/detail2/12'">
				<p>
					<strong>프로필</strong>
				</p>
				<p>Jean</p>
				...
				<button class="btn btn-default"
					onclick="location.href='/product/detail2/12'">More Click
				</button>
			</div>
		</div>
